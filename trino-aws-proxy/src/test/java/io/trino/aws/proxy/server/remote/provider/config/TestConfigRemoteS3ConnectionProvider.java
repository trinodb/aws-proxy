...
public class TestConfigRemoteS3ConnectionProvider
        extends AbstractTestProxiedRequests
{
            ...
            implements BuilderFilter
    {
        ...
        public Builder filter(Builder builder)
        {
            return builder
                    ...
                    .withProperty("remote-s3-connection-provider.type", "config")
    ...
    @Inject
    public TestConfigRemoteS3ConnectionProvider(S3Client s3Client, @ForS3Container S3Client storageClient, TestingS3RequestRewriteController requestRewriteController)
    {
