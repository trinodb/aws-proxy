        ...
        extends AbstractTestProxiedRequests
{
            ...
            TestingCredentialsRolesProvider testingCredentialsRolesProvider)
    {
        ...
        testingCredentialsRolesProvider.addCredentials(identityCredential, new RemoteS3Connection(POLICY_USER_CREDENTIAL, Optional.of(remoteSessionRole), Optional.empty()));
