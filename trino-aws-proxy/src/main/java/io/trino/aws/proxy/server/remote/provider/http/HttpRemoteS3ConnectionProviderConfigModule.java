...
public class HttpRemoteS3ConnectionProviderConfigModule
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        install(remoteS3ConnectionProviderModule(
                ...
                innerBinder -> {
                    httpClientBinder(innerBinder).bindHttpClient("remote-s3-connection-provider", ForHttpRemoteS3ConnectionProvider.class);
                    ...
                    jsonCodecBinder(innerBinder).bindJsonCodec(RemoteS3ConnectionRequest.class);
                    jsonCodecBinder(innerBinder).bindJsonCodec(RemoteS3Connection.class);
                }));
    }
}
